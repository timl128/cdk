...
public class PipelineStack extends Stack {
    ...
    private static final String GITHUB_REPO = "cdk";
    ...
    public PipelineStack(final App parent, final String name, final StackProps props) {
        ...
        // Create a pipeline
        Pipeline pipeline = new Pipeline(this, "DemoPipeline", PipelineProps.builder().build());
        ...
        PipelineProject buildProject = new PipelineProject(this, "DemoProject",
            PipelineProjectProps.builder()
                .withEnvironment(buildEnvironment)
                .withBuildSpec(GITHUB_CDK_PATH + "/buildspec.yml")
